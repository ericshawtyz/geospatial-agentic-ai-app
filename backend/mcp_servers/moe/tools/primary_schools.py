...
@mcp.tool()
async def query_primary_schools(
    postalcode: str,
    blk_no: str,
) -> dict:
    """Query primary schools near a given address in Singapore.
    ...
    The response includes a dist_code field for each school:
      - dist_code "1" = within 1 km of the address (P1 registration Phase 2B/2C priority)
      - dist_code "2" = between 1-2 km of the address (P1 registration lower priority)
    ...
    return await moe_get("/api/onemap/moe/querySchools", params)
